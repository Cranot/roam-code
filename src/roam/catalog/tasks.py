...
CATALOG: dict[str, dict] = {
        ...
        "ways": [
            {
                ...
                "space": "O(n)",
                "rank": 1,
                "tip": "Use sorted() / list.sort() / Arrays.sort()",
            },
            {
                "id": "manual-sort",
                "name": "Manual bubble/selection sort",
                "time": "O(n^2)",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
        ...
        "ways": [
            {
                ...
                "space": "O(1)",
                "rank": 1,
                "tip": "Use bisect / binary_search / Arrays.binarySearch()",
            },
            {
                "id": "linear-scan",
                "name": "Linear scan",
    ...
    "membership": {
        ...
        "ways": [
            {
                "id": "set-lookup",
                "name": "Set/hash lookup",
                "time": "O(1) amortized",
                "space": "O(n)",
                "rank": 1,
                "tip": "Convert to set for repeated lookups",
            },
            {
                "id": "list-scan",
    ...
    "unique": {
        ...
        "ways": [
            {
                "id": "set-dedup",
                "name": "Set-based dedup",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 1,
                "tip": "Use set() / dict.fromkeys() / [...new Set(arr)]",
            },
            {
                "id": "nested-dedup",
                "name": "Nested loop dedup",
                "time": "O(n^2)",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
    ...
    "max-min": {
        ...
        "ways": [
            {
                "id": "builtin-minmax",
                "name": "Built-in max()/min()",
                "time": "O(n)",
                "space": "O(1)",
                "rank": 1,
                "tip": "Use max() / min() / Math.max() / Collections.max()",
            },
            {
                "id": "manual-loop",
                "name": "Manual tracking loop",
                "time": "O(n)",
                "space": "O(1)",
                "rank": 5,
                "tip": "",
    ...
    "accumulation": {
        ...
        "ways": [
            {
                "id": "builtin-sum",
                "name": "Built-in sum/reduce",
                "time": "O(n)",
                "space": "O(1)",
                "rank": 1,
                "tip": "Use sum() / math.prod() / reduce() / stream().reduce()",
            },
            {
                "id": "manual-sum",
                "name": "Manual accumulator",
                "time": "O(n)",
                "space": "O(1)",
                "rank": 5,
                "tip": "",
    ...
    "fibonacci": {
        ...
        "ways": [
            {
                "id": "iterative-fib",
                "name": "Iterative / memoized",
                "time": "O(n)",
                "space": "O(1)",
                "rank": 1,
                "tip": "Use iterative loop or @lru_cache / @cache",
            },
            {
                "id": "naive-recursive",
        ...
        "ways": [
            {
                ...
                "space": "O(1)",
                "rank": 1,
                "tip": "Use pow(base, exp, mod) / ** / Math.pow()",
            },
            {
                "id": "loop-multiply",
    ...
    "manual-gcd": {
        ...
        "ways": [
            {
                "id": "builtin-gcd",
                "name": "Built-in math.gcd",
                "time": "O(log n)",
                "space": "O(1)",
                "rank": 1,
                "tip": "Use math.gcd() / BigInteger.gcd() / __gcd()",
            },
            {
                "id": "manual-gcd",
                "name": "Manual loop",
    ...
    "groupby": {
        ...
        "ways": [
            {
                "id": "defaultdict-groupby",
                "name": "defaultdict / Collectors.groupingBy",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 1,
                "tip": "Use defaultdict(list) / setdefault() / Collectors.groupingBy()",
            },
            {
                "id": "manual-check",
                "name": "Manual key-existence check",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 5,
                "tip": "",
    ...
    "string-reverse": {
        ...
        "ways": [
            {
                "id": "builtin-reverse",
                "name": "Built-in reverse/slice",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 1,
                "tip": "Use s[::-1] / StringBuilder.reverse() / strings.Reverse()",
            },
            {
                "id": "manual-reverse",
                "name": "Manual char loop",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 5,
                "tip": "",
    ...
    "matrix-mult": {
        ...
        "ways": [
            {
                "id": "blas-mult",
                "name": "NumPy / BLAS (optimized)",
                "time": "O(n^3)",
                "space": "O(n^2)",
                "rank": 1,
                "tip": "Use numpy.dot() / np.matmul() / @ operator (100-1000x faster via SIMD+cache)",
            },
            {
                "id": "naive-triple",
                "name": "Naive triple loop",
                "time": "O(n^3)",
                "space": "O(n^2)",
                "rank": 10,
                "tip": "",
    ...
    "busy-wait": {
        ...
        "ways": [
            {
                "id": "event-wait",
                "name": "Event / condition variable",
                "time": "O(1) wake",
                "space": "O(1)",
                "rank": 1,
                "tip": "Use threading.Event / asyncio.Event / select() / Promise",
            },
            {
                "id": "sleep-loop",
                "name": "Sleep-in-loop polling",
                "time": "O(k) polls",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
        ...
        "ways": [
            {
                ...
                "space": "O(p)",
                "rank": 1,
                "tip": "Compile once outside the loop: re.compile() / new RegExp() / Pattern.compile()",
            },
            {
                "id": "compile-per-iter",
                "name": "Compile per iteration",
                "time": "O(n*(p+m))",
                "space": "O(p)",
                "rank": 10,
                "tip": "",
    ...
    "io-in-loop": {
        ...
        "ways": [
            {
                "id": "batch-query",
                "name": "Batch query / bulk I/O",
                "time": "O(1) round trips",
                "space": "O(n)",
                "rank": 1,
                "tip": "Use WHERE IN (...) / bulk API / batch fetch instead of per-item queries",
            },
            {
                "id": "loop-query",
                "name": "Per-item query in loop",
                "time": "O(n) round trips",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
            },
    ...
    "chained-collection-walk": {
        ...
        "ways": [
            {
                "id": "single-pass",
                "name": "Single-pass equivalent (.find / .some / .every)",
                "time": "O(n) with early exit",
                "space": "O(1)",
                "rank": 1,
                "tip": "Combine the predicates: `.find(x => predA(x) && predB(x))` instead of `.filter(predA).find(predB)`. Use `.some()` instead of `.filter().length > 0`.",
            },
            {
                "id": "two-pass-walk",
                "name": "Filter+find / map+find chain",
                "time": "O(n) twice",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
    ...
    "defer-in-loop": {
        "name": "Go defer inside loop accumulates per-iteration",
        "category": "concurrency",
        "kind": "algorithm",
        "ways": [
            {
                "id": "extract-helper",
                "name": "Extract loop body to a function",
                "time": "O(1) per call",
                "space": "O(1)",
                "rank": 1,
                "tip": "Move the body into a small helper so each iteration's `defer` fires when the helper returns. Or close resources explicitly at the end of the loop.",
            },
            {
                "id": "loop-defer",
                "name": "defer inside for/range body",
                "time": "O(n) live deferrals",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
            },
    ...
    "spread-accumulator": {
        "name": "Spread accumulator in loop / reduce — O(n^2)",
        "category": "concurrency",
        "kind": "algorithm",
        "ways": [
            {
                "id": "mutate-in-place",
                "name": ".push() / Object.assign() / .set()",
                "time": "O(n)",
                "space": "O(n)",
                "rank": 1,
                "tip": "Mutate the accumulator: `acc.push(x)` instead of `acc = [...acc, x]`. For Map/Set use the typed collection.",
            },
            {
                "id": "spread-rebind",
                "name": "Spread + re-assign accumulator",
                "time": "O(n^2)",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
    ...
    "async-blocking-sleep": {
        "name": "Blocking call inside async function (event-loop stall)",
        "category": "concurrency",
        "kind": "algorithm",
        "ways": [
            {
                "id": "await-asyncio-sleep",
                "name": "await asyncio.sleep / async client",
                "time": "non-blocking",
                "space": "O(1)",
                "rank": 1,
                "tip": "Replace `time.sleep(n)` with `await asyncio.sleep(n)`; use httpx.AsyncClient / aiohttp instead of requests; use an async DB driver (asyncpg / aiomysql).",
            },
            {
                "id": "blocking-call-in-async",
                "name": "Blocking call inside async function",
                "time": "stalls event loop O(call latency)",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
            },
    ...
    "serial-await-loop": {
        ...
        "ways": [
            {
                "id": "promise-all",
                "name": "Promise.all of map",
                "time": "O(1) wall (parallel)",
                "space": "O(n)",
                "rank": 1,
                "tip": "Replace `for (x of items) { await fn(x); }` with `await Promise.all(items.map(fn));`",
            },
            {
                "id": "for-of-await",
                "name": "Serial await in for-of",
                "time": "O(n) wall (serial)",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
            },
    ...
    "list-prepend": {
        ...
        "ways": [
            {
                "id": "deque-ops",
                "name": "Deque / append+reverse",
                "time": "O(1) per op",
                "space": "O(n)",
                "rank": 1,
                "tip": "Use collections.deque / ArrayDeque / append+reverse instead of insert(0,x)",
            },
            {
                "id": "insert-front",
                "name": "Insert/remove at front",
                "time": "O(n) per op",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
    ...
    "sort-to-select": {
        ...
        "ways": [
            {
                "id": "direct-select",
                "name": "Direct min/max or heap",
                "time": "O(n) or O(n log k)",
                "space": "O(1) or O(k)",
                "rank": 1,
                "tip": "Use min()/max() for extremes, heapq.nsmallest/nlargest for top-k",
            },
            {
                "id": "full-sort",
                "name": "Full sort then subscript",
                "time": "O(n log n)",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
    ...
    "loop-lookup": {
        ...
        "ways": [
            {
                "id": "set-prebuilt",
                "name": "Pre-built set/dict",
                "time": "O(1) per lookup",
                "space": "O(m)",
                "rank": 1,
                "tip": "Build a set/dict from the lookup collection once, then use O(1) membership",
            },
            {
                "id": "method-scan",
                "name": ".index()/.contains() in loop",
                "time": "O(m) per lookup",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
    ...
    "branching-recursion": {
        ...
        "ways": [
            ...
            {
                "id": "naive-branching",
                "name": "Naive branching recursion",
                "time": "O(2^n)",
                "space": "O(n)",
                "rank": 10,
                "tip": "",
        ...
        "ways": [
            {
                ...
                "space": "O(n)",
                "rank": 1,
                "tip": "Append parts to a list, then ''.join(parts) at the end",
            },
            {
                "id": "augment-concat",
                "name": "str += in loop",
    ...
    "loop-invariant-call": {
        ...
        "ways": [
            {
                "id": "hoisted",
                "name": "Call hoisted before loop",
                "time": "O(1) per iter",
                "space": "O(1)",
                "rank": 1,
                "tip": "Move the call before the loop and store the result in a variable",
            },
            {
                "id": "repeated-call",
                "name": "Repeated call per iteration",
                "time": "O(f(x)) per iter",
                "space": "O(1)",
                "rank": 10,
                "tip": "",
