...
class Indexer:
    ...
    def run(
        ...
        try:
            ...
            # Pass 40 — graceful Ctrl-C: drop the lock so the user can
    ...
    def _read_index_source(self, full_path: Path, rel_path: str, verbose: bool) -> bytes | None:
        # Prefetched cache hit (Pass 29 — parallel I/O prefetch).
    ...
    def _prefetch_sources(self, files_to_process, verbose: bool) -> None:
        ...
        Pass 29 — opt-in via ``ROAM_PARALLEL_INDEX=1``. File I/O dominates
