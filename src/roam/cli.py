...
_COMMANDS = {
    ...
    "cycle-break": ("roam.commands.cmd_cycle_break", "cycle_break"),
    ...
    "reachability-triage": (
        "roam.commands.cmd_reachability_triage",
        "reachability_triage_cmd",
    ),
    ...
    "dogfood": ("roam.commands.cmd_dogfood", "dogfood_cmd"),
    ...
    "calc-inventory": ("roam.commands.cmd_calc_inventory", "calc_inventory"),
    "calc-probe": ("roam.commands.cmd_calc_probe", "calc_probe"),
    "calc-golden": ("roam.commands.cmd_calc_golden", "calc_golden"),
    ...
    "profile-import": ("roam.commands.cmd_profile_import", "profile_import"),
    ...
    "ignore-drift": ("roam.commands.cmd_ignore_drift", "ignore_drift"),
    ...
    "surface-gaps": ("roam.commands.cmd_surface_gaps", "surface_gaps"),
