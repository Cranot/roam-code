...
_DOCS_LINK = "https://cranot.github.io/roam-code/"
...
def _section_concerns(concerns: list[dict]) -> list[str]:
    ...
    for i, c in enumerate(concerns, 1):
        ...
        # T8 (2026-05-06) — surface matched_patterns when present so reviewers
...
def _section_rule_violations(rule_violations: list[dict]) -> list[str]:
    ...
    for v in warn_v[:5]:
        ...
        out.extend(_render_context_lines(v.get("context_lines"), indent="  "))
    # S8 (2026-05-06) — when more than the first-5 limit of either tier
...
def _render_plain(envelope: dict) -> str:
    ...
    if concerns:
        ...
        for i, c in enumerate(concerns, 1):
            ...
            # U8 (2026-05-06) — plain renderer also surfaces matched_patterns
