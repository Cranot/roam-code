...
def _git_dirty_count() -> int | None:
    ...
    git is unavailable. Pass 32 — surfaces working-tree drift that the
...
def index_status() -> dict | None:
    ...
    commits indexed, env opt-out). Otherwise:

        {
          ...
          "indexed_commit": "...",
          "head_commit": "...",
          "dirty_files": int | None,   # Pass 32 — working-tree drift count
          "hint": "...",
        }
    ...
    # Pass 32 — even when HEAD matches, working-tree edits make the
