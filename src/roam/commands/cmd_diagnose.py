...
@click.option(
    ...
    type=str,
    default=None,
    help='Pass 74 — read newline-separated symbol names from this file ("-" for stdin) and run diagnose on each.',
)
@click.pass_context
def diagnose(ctx, name, depth, batch_input):
    ...
    # Pass 74 — batch mode runs diagnose on N symbols. Stream output as
