...
def math_cmd(
    ...
    # T7 (2026-05-06) — auto-detect when no --framework was passed.
    ...
    with open_db(readonly=True) as conn:
        ...
        # T5 (2026-05-06) — `--since baseline.json`: keep only findings whose
        ...
        # W9 (2026-05-06) — when many findings cluster on one detector, hint
                ...
                to_json(
                    json_envelope(
                        ...
                        summary={
                            ...
                            # W8 (2026-05-06) — surface T7 auto-detection in JSON summary
        ...
        # S7 (2026-05-06) — surface the active framework profile inline so
        ...
        for task_id, task_findings in by_task.items():
            ...
            for f in task_findings:
                ...
                # U6 (2026-05-06) — surface matched_patterns on a single line
