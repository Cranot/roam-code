...
# E2 (2026-05-06) — `class Foo extends Bar` → Bar is the parent class.
...
# Real-world FP from union-web: ~115 controller methods flagged because
...
def _analyze_controller_file(
    ...
    # E2 (2026-05-06) — also walk the extends chain so a controller that
    ...
    for method in methods:
        ...
        # U4 (2026-05-06) — `matched_patterns` lists the structural signals
...
def auth_gaps_cmd(ctx, limit, routes_only, controllers_only, min_confidence):
    ...
    if ctrl_findings:
        ...
        # W3 (2026-05-06) — when many findings cluster on a few controllers
