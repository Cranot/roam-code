...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="Pass 68 — aggregate clone pairs into file-pair coupling, surface the top-coupled file pairs.",
)
@click.pass_context
def clones(ctx, threshold, min_lines, scope, top, persist, by_file):
    ...
    with open_db(readonly=not persist) as conn:
        ...
        # Pass 68 — aggregate clone pairs into (file_a, file_b) coupling.
        if by_file:
