...
Pass 80 — with ``--check``, also queries PyPI (with a tight timeout) to
...
@click.command()
@click.option("--check", "do_check", is_flag=True, help="Pass 80 — also query PyPI for the latest version.")
@click.pass_context
