...
def health(ctx, no_framework, gate, explain):
    ...
    with open_db(readonly=True) as conn:
        ...
        # Pass 34 — record per-factor contributions so --explain can show
        ...
        # X12 (2026-05-06) — when 0 actionable items remain (everything was
        ...
        click.echo(f"VERDICT: {verdict}\n")
        # Pass 34 — when --explain, decompose the score before everything
