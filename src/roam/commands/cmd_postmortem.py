...
Phase 0.3 of the v2 monetization plan: stand-alone OSS artifact
that becomes the highest-conversion buyer-meeting demo. The pull
quote we want is:
...
def postmortem_cmd(ctx, commit_range: str, limit: int, show_n: int):
    ...
    The single highest-conversion buyer-meeting demo per the
