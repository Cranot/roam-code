...
CRITERIA_DATA: dict[str, dict[str, object]] = {
    "roam-code": {
        ...
        "call_graph": "cross_file",
        "cognitive_complexity": True,
        "vuln_reachability": "graph",
        "dead_code": "dataflow",
        "dataflow_taint": "inter",
        "languages_supported": 27,
        "pagerank_centrality": True,
        "cycle_detection_scc": True,
        "community_detection": True,
        "topological_layers": True,
        "architecture_simulation": True,
        "topology_fingerprint": True,
        "git_churn_hotspots": True,
        "co_change_coupling": True,
    ...
    "CKB/CodeMCP": {
        ...
        "topology_fingerprint": False,
        "git_churn_hotspots": True,
        "co_change_coupling": False,
        "blame_ownership": True,
        ...
        "tool_presets": True,
        "sarif_output": False,
        "cli_commands_count": 0,
        "compound_batch": True,
        "local_zero_api": True,
        "vuln_scanning": False,
        "reachability_from_vulns": False,
        "secret_detection": "regex",
        "quality_gates": False,
        "rule_count": 0,
        "open_source": "full",
        "free_tier": True,
        "zero_config_setup": "light_config",
        "ci_cd_integration": False,
        "ide_integration": False,
        "multi_platform": True,
        "documentation_quality": 1,
        "active_maintenance": True,
        "multi_agent_partitioning": False,
        "structural_pattern_matching": False,
        "semantic_search": True,
        "multi_repo_federation": True,
        "daemon_live_watch": True,
    },
    ...
    "SonarQube": {
        ...
        "tool_presets": False,
        "sarif_output": True,
        "cli_commands_count": 5,
        "compound_batch": False,
        "local_zero_api": False,
        "vuln_scanning": True,
        "reachability_from_vulns": True,
        "secret_detection": "remediation",
        "quality_gates": True,
        ...
        "open_source": "partial",
        "free_tier": True,
        "zero_config_setup": "heavy_config",
        "ci_cd_integration": True,
        "ide_integration": True,
        "multi_platform": True,
        "documentation_quality": 2,
...
MAP_METADATA: dict[str, dict[str, object]] = {
    "roam-code": {
        ...
        "note": "Graph algorithms (PageRank, SCC, Louvain, Fiedler) on tree-sitter ASTs fused with git history in SQLite. 244 MCP tools, 283 CLI commands. 19 Python idiom detectors (v12.7+). 54 algo detectors (12.40). Audit-trail commands: permit / postmortem / article-12-check.",
...
def compute_scores(
    ...
    map_y = round(
        (
            ...
            + _safe(gt["score"], gt["max"]) * 0.25
        )
        * 100
    )
    map_x = round((_safe(ai["score"], ai["max"]) * 0.70 + _safe(ea["score"], ea["max"]) * 0.30) * 100)
...
def _matrix_to_competitors(
    ...
    if missing_metadata:
        raise ValueError("Missing MAP_METADATA entries for competitors: " + ", ".join(sorted(missing_metadata)))
    return competitors
...
def _append_extra_competitors(
    ...
    for name, meta in MAP_METADATA.items():
        ...
        entry: dict[str, object] = {
            ...
            "setup": str(criteria.get("zero_config_setup", "light_config")),
