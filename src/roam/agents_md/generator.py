...
def _agents_md_options(
    ...
    return AgentsMdOptions(
        ...
        attribution=legacy_options.get("attribution", resolved.attribution),
    )
...
def generate_agents_md(
    ...
    **legacy_options: Any,
    ...
    am.attribution = opts.attribution
...
def _render_quick_read(am: AgentsMd) -> list[str]:
    ...
    if am.attribution:
        # F14 — one factual line: what made this file + how to install it.
        lines.append(
            "> Generated with [roam-code](https://github.com/Cranot/roam-code) "
            "(`pip install roam-code`) - a static code-intelligence tool for AI agents."
        )
    lines.extend(
        [
            "",
