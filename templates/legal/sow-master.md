...
- **Provider**: `[PROVIDER_LEGAL_NAME]`, `[PROVIDER_ENTITY_TYPE]` (e.g. Stripe Atlas Delaware C-corp / Greek freelancer Α.Φ.Μ. `[VAT_ID]`), with registered address at `[PROVIDER_ADDRESS]` ("**Provider**", "we", "us").
