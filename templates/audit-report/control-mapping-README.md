...
- Do **not** use "certifies", "makes compliant", "guaranteed", or any phrase
  ...
  `dev/BUILD-PRIORITIES-2026-05-13.md` (P0.3-P0.4) for the wider rule.

## Current schema: v1 (`control_mapping/v1`)

Each entry in `controls:` carries the following fields. Items marked **NEW
in v1** were added per `dev/AGENTIC-ASSURANCE-CROSSWALK-2026-05-13.md`
"Build deltas" item 5.
...
- Architecture: `dev/ARCHITECTURE-EVIDENCE-COMPILER-2026-05-13.md`
  ("Policy and control mapping" section).
- Crosswalk (drives v1 schema additions):
  `dev/AGENTIC-ASSURANCE-CROSSWALK-2026-05-13.md` ("Build deltas" item 5).
