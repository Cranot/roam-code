...
| `src/roam/commands/` | HIGH | 1 | CosmoHac | 100% | no |
| `src/roam/languages/` | HIGH | 1 | CosmoHac | 94% | no |
...
| `rules/community/security/` | HIGH | 1 | CosmoHac | 100% | no |
| `./` | HIGH | 1 | CosmoHac | 98% | no |
| `rules/community/correctness/` | HIGH | 1 | CosmoHac | 100% | no |
| `rules/community/style/language-pack/` | HIGH | 1 | CosmoHac | 100% | no |
