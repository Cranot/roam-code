...
a local SQLite DB. 144 commands, 101 MCP tools,
...
src/roam/
  ...
  commands/
    ...
    cmd_*.py           # One module per CLI command (141 modules, 144 commands)
  output/
...
Run `roam --help` for all 144 commands. Use `roam --json <cmd>` for structured output.
