...
a local SQLite DB. 139 commands, 101 MCP tools,
...
src/roam/
  ...
  commands/
    ...
    cmd_*.py           # One module per CLI command (137 modules, 139 commands)
  output/
...
Run `roam --help` for all 139 commands. Use `roam --json <cmd>` for structured output.
