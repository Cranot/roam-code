...
```bash
roam describe --write
roam describe --agent-prompt    # compact ~500-token prompt
```
...
This skill covers the most common commands, but roam has 95+ commands.
