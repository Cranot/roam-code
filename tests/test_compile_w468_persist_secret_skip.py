...
SENSITIVE = ["grep", "retrieve", "search-semantic", "taint", "file",
             "refs-text", "history-grep", "config"]
SAFE = ["uses", "impact", "dead", "complexity", "clusters", "deps", "search",
        "brief", "coupling", "batch-search"]
