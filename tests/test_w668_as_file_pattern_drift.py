...
Companion docs: ``dev/W668-AS-FILE-AUDIT-2026-05-15.md``.
"""
...
def test_no_as_file_path_captured_outside_with_block() -> None:
    ...
    See the module docstring + ``dev/W668-AS-FILE-AUDIT-2026-05-15.md``
    ...
    assert offenders == [], (
        ...
        "Offenders:\n" + "\n".join(offenders) + "\nSee `dev/W668-AS-FILE-AUDIT-2026-05-15.md` for the fix template."
    )
