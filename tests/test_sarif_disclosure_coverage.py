...
See:
- dev/SARIF-DISCLOSURE-PATTERN-MATURITY-2026-05-16.md §8 (lint sketch)
...
def test_sarif_disclosure_coverage():
    ...
    See dev/SARIF-DISCLOSURE-PATTERN-MATURITY-2026-05-16.md §8 for the
    ...
    assert not unexpected, (
        ...
        f"See dev/SARIF-DISCLOSURE-PATTERN-MATURITY-2026-05-16.md §8 for "
