        ...
        proj = project_factory(
            {
                "waiter.py": (
                    "import time\n"
                    # T2 (2026-05-06): keep the function name free of poll
...
class TestAsyncBlockingSleep:
    """X1 (2026-05-06) — blocking calls inside async function (event-loop stall)."""
...
class TestBroadExceptSwallow:
    """X2 (2026-05-06) — bare `except Exception:` without re-raise is a swallow."""
