...
See the [Architecture Guide](https://cranot.github.io/roam-code/architecture.html) for the complete conventions reference.
...
See the [Architecture Guide](https://cranot.github.io/roam-code/architecture.html) for the full list of patterns and conventions.
...
For full architectural details, see the [Architecture Guide](https://cranot.github.io/roam-code/architecture.html).
...
- See the [Architecture Guide](https://cranot.github.io/roam-code/architecture.html) for detailed technical conventions
