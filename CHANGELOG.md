...
PR Replay is the lowest-friction path to first dollar: paid up-front,
no SaaS recurring infra needed, the artifact closes Roam Review deals.
...
- Author rewrite: 389 commits authored as "CosmoHac" + 11 commits
...
- `authors` updated to `Cranot` (was `CosmoHac`).
