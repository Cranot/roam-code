...
- **MCP-COMPAT-PROFILE-ROADMAP** — docs(research): Wave-C planning memo at `dev/MCP-COMPAT-PROFILE-ROADMAP-2026-05-17.md` (compat-profile-emit + `roam mcp doctor` probe surface for client-side capability negotiation).
...
- **DETECTOR-FP-RATE-METHODOLOGY** — docs(research): memo at `dev/DETECTOR-FP-RATE-METHODOLOGY-2026-05-16.md` (674 words, 12 sources cited; methodology for measuring detector false-positive rates).
...
- **W767** — docs(mcp): outputSchema inventory at `dev/MCP-OUTPUTSCHEMA-INVENTORY-2026-05-16.md` (57 core tools catalogued, 5-wave Wave B roadmap).
- **MCP-OUTPUTSCHEMA-EVOLUTION** — docs(mcp): research memo at `dev/MCP-OUTPUTSCHEMA-EVOLUTION-2026-05-16.md` (Claude Code #25081 status shifted; 3-wave roadmap).
...
- W850: dev/ROAM-DETECTOR-INVENTORY-2026-05-15.md
...
- **`dev/MCP-ELICITATION-CANDIDATES-2026-05-15.md`** (W768) — Top-3 elicitation candidates: `roam_mutate`, `roam_cga_emit`, `roam_annotate_symbol`. 4 prerequisites; 4 runner-up candidates.
...
- **W850 — `dev/ROAM-DETECTOR-INVENTORY-2026-05-15.md`.** 94 distinct detectors catalogued across the codebase. The first single source of truth for the full detector roster.
...
> Source Track positioning, `dev/SLSA-V12-POSITIONING-2026-05-15.md`)
...
- **W433-research — `effects_taint` optimization scoping**. Memo at
  `dev/EFFECTS-TAINT-PERF-RESEARCH-2026-05-15.md`. Three candidates
...
- **W359-research — OSCAL v1.2 Control Mapping decision**. Memo at
  `dev/OSCAL-V12-CONTROL-MAPPING-2026-05-15.md`. SURPRISE: OSCAL v1.2
