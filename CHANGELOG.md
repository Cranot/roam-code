...
- **MCP-COMPAT-PROFILE-ROADMAP** — docs(research): Wave-C planning memo at `dev/MCP-COMPAT-PROFILE-ROADMAP-2026-05-17.md` (compat-profile-emit + `roam mcp doctor` probe surface for client-side capability negotiation). <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **DETECTOR-FP-RATE-METHODOLOGY** — docs(research): memo at `dev/DETECTOR-FP-RATE-METHODOLOGY-2026-05-16.md` (674 words, 12 sources cited; methodology for measuring detector false-positive rates). <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **W767** — docs(mcp): outputSchema inventory at `dev/MCP-OUTPUTSCHEMA-INVENTORY-2026-05-16.md` (57 core tools catalogued, 5-wave Wave B roadmap). <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
- **MCP-OUTPUTSCHEMA-EVOLUTION** — docs(mcp): research memo at `dev/MCP-OUTPUTSCHEMA-EVOLUTION-2026-05-16.md` (Claude Code #25081 status shifted; 3-wave roadmap). <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> and two new research memos (`dev/PATTERN-2-EVOLUTION-2026-05-16.md`
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
> already shipped in CONSOLIDATE-13; `dev/DETECTOR-FP-RATE-BENCHMARKS-2026-05-16.md`
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> (`dev/PATTERN-2-EVOLUTION-2026-05-16.md`) cataloguing the
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Research memo — `dev/PATTERN-2-EVOLUTION-2026-05-16.md` (884 LOC).** Catalogues the **seven-variant Pattern-2 family taxonomy** as of 2026-05-16: 2a compound-recipe / 2b empty-corpus / 2c resolution-state (W1241 helper substrate) / 2d producer-gap (W261 redaction reason) / 2e shared-substrate (W1018 YAML loader) / 2f packet-layer (W210 evidence_stale) / 2g closed-vocabulary-unknown (W1077/W1080 structured_unknown). Companion to `dev/PATTERN-2-EVOLUTION-2026-05-15.md` (yesterday's Python-3.11+ language-feature survey of `warnings_out` — verdict STAY). Surfaces seven open gaps + counts adoption per variant. No source changes; sequencing decisions are Cranot's.
<!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **W1102-RESEARCH — Click-argument rename strategy memo.** 677-line research memo at `dev/CLICK-ARGUMENT-RENAME-STRATEGY-2026-05-15.md`. Key finding: the MCP boundary is already sealed via the `_PARAM_ALIASES` table landed in W430, so the CLI-side `@click.argument("name")` drift does NOT silent-fail through MCP. Recommendation: ship the W1111 AST CI lint (DONE) to lock the current 12-site grandfather surface; defer a hard rename until v14.0 ships for an unrelated breaking-change reason. **W1098 USER-DECISION downgraded from BLOCKER to FOLLOW-UP.** <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- W850: dev/ROAM-DETECTOR-INVENTORY-2026-05-15.md <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **`dev/MCP-EVOLUTION-2026-05-15.md`** (W758) — MCP protocol evolution since 2025-11-25 spec freeze. **Headline: Claude Code bug #25081 silently drops ALL tools from any server that declares `toolAnnotations` or `outputSchema`** — hard block on tool-annotation adoption (W764 / W767 BLOCKED). 5 follow-up waves suggested.
- **`dev/MCP-SERVER-CARD-2026-05-15.md`** (W765) — MCP Server Card readiness vs SEP-2127 draft. 7 gaps; 4 ready (W792-W794); 1 BLOCKED on SEP-2127 merge (W795). 10 sources cited.
- **`dev/MCP-TASKS-EVAL-2026-05-15.md`** (W766) — MCP Tasks primitive evaluation. **CRITICAL: 8 sync tools falsely declared in `_TASK_OPTIONAL_TOOLS`** (W785 captured). 10 candidate tools; 6 prerequisites; 3-tool migration order.
- **`dev/MCP-ELICITATION-CANDIDATES-2026-05-15.md`** (W768) — Top-3 elicitation candidates: `roam_mutate`, `roam_cga_emit`, `roam_annotate_symbol`. 4 prerequisites; 4 runner-up candidates. <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
- **`dev/DETECTOR-FP-METHODOLOGY-2026-05-15.md`** (W480) — FP-rate methodology: hybrid (OWASP Benchmark / public corpora / internal dogfood). **CRITICAL: 93% of BigCloneBench's Weak Type-3/4 pairs are mislabeled** per arXiv 2505.04311 (W797 captured). 13 sources cited.
...
- **W848 — `dev/PRINCIPLE-ENFORCEMENT-ROADMAP-2026-05-15.md`.** Fowler 22-smell coverage map + top-3 recommendations for the next detector wave. Drove the W852-W857 selection.
- **W849 — `dev/DRY-BEYOND-LITERAL-CLONES-2026-05-15.md`.** Research memo identifying *cross-layer duplication* as the #1 real-world DRY debt class. Directly drove the W856 design (Jaccard over callee-name multisets across layers, NOT raw clone detection).
- **W850 — `dev/ROAM-DETECTOR-INVENTORY-2026-05-15.md`.** 94 distinct detectors catalogued across the codebase. The first single source of truth for the full detector roster. <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> shipped** (`dev/CMD-ALERTS-PATTERN-2-CASE-STUDY-2026-05-15.md`,
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> research** — **W470-research** (`dev/DETECTOR-FP-RATE-METHODOLOGY-2026-05-15.md`)
...
- **W470-research — Detector FP-rate measurement methodology.**
  Memo at `dev/DETECTOR-FP-RATE-METHODOLOGY-2026-05-15.md`. Three
...
> Source Track positioning, `dev/SLSA-V12-POSITIONING-2026-05-15.md`) <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> `dev/OSCAL-V12-CONTROL-MAPPING-2026-05-15.md`) found that OSCAL v1.2
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
> (`dev/EFFECTS-TAINT-PERF-RESEARCH-2026-05-15.md`) scoped three
> <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **MCP wrapper backfill — Wave29 sub-waves** (W299-W302). Four
  ...
  **75 → 67 → 57 → 47 → 38**: W299 added 9 exploration-cluster
  ...
  `dev/WAVE29-MCP-WRAPPER-PLAN-2026-05-15.md` (W353).
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **TEAM-MCP-AUTHORITY-PRODUCT facade refresh** (W367). Updated
  `dev/TEAM-MCP-AUTHORITY-PRODUCT-2026-05-14.md` to reflect the
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Strategic memos shipped overnight.** Five new dev docs landed
  ...
  `dev/MILESTONE-2026-05-13-AGENTIC-ASSURANCE.md` (W202 milestone
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  integration note); `dev/THREAT-MODEL-MCP-2026-05-14.md` (W214 — 6
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  threats, conditional P-tier escalation contingent on Team MCP
  Gateway shipping); `dev/POSITIONING-TEAM-MCP-2026-05-14.md` (W215
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  — authority-product framing); `dev/DEMO-NARRATIVE-CANONICAL.md`
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  (W216 — 8/8 ideal-case fixture, deterministic content_hash
  `17958f73…`); `dev/PIPELINE-REVALIDATION-2026-05-14.md` (W230 —
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Producer coverage matrix** (W252) —
  `dev/PRODUCER-COVERAGE-MATRIX-2026-05-14.md` (168 lines). 15
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **MCP Pattern-1 family audit** (W315). Sonnet+web research pass
  ...
  `dev/MCP-PATTERN-1-FAMILY-AUDIT-2026-05-15.md`. Drove the W325
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Pattern 3 + Pattern 6 audit** (W329). Sonnet+web pass that
  ...
  `dev/PATTERN-3-AND-6-AUDIT-2026-05-15.md`. Drove the W330
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **MCP state-mutating patterns** (W340). Sonnet+web pass that
  ...
  lives at `dev/MCP-STATE-MUTATING-PATTERNS-2026-05-15.md`.
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
- **Standards currency audit** (W341). Sonnet+web pass against
  ...
  `dev/STANDARDS-CURRENCY-AUDIT-2026-05-15.md`. Headline finding:
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Detector competitive audit** (W368). Sonnet+web pass against
  ...
  `dev/DETECTOR-COMPETITIVE-AUDIT-2026-05-15.md`.
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
- **Ecosystem positioning audit** (W385). Sonnet+web pass against
  ...
  `dev/ECOSYSTEM-POSITIONING-2026-05-15.md`. Feeds the W390 / W393
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Performance benchmarking research** (W395). Sonnet+web pass
  ...
  **5-20x faster than CodeQL** for comparable analysis depth on a
  ...
  `dev/PERFORMANCE-BENCHMARKING-2026-05-15.md`. The five sub-waves
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **llm-smells pattern catalog** (W402-research). Sonnet+web pass
  ...
  `dev/LLM-SMELLS-PATTERN-CATALOG-2026-05-15.md`. Estimated v1
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **OWASP 2026 taint rule pack research** (W372-research). Sonnet+web
  ...
  `dev/OWASP-TAINT-RULE-PACK-RESEARCH-2026-05-15.md`. Identified 3
...
- **Phase 4-7 perf research** (W395-followup). Sonnet+web pass that
  ...
  `dev/PERF-PHASES-4-7-RESEARCH-2026-05-15.md`. Top 3 actionable
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Standards crosswalk additions research** (W360-research).
  ...
  W341 audit. Memo at `dev/CROSSWALK-ADDITIONS-2026-05-15.md`.
...
- **W433-research — `effects_taint` optimization scoping**. Memo at
  `dev/EFFECTS-TAINT-PERF-RESEARCH-2026-05-15.md`.
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  Three candidates
...
- **W358-research — SLSA v1.2 Source Track positioning**. Memo at
  `dev/SLSA-V12-POSITIONING-2026-05-15.md`. **roam de-facto covers
...
- **W359-research — OSCAL v1.2 Control Mapping decision**. Memo at
  `dev/OSCAL-V12-CONTROL-MAPPING-2026-05-15.md`.
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
  SURPRISE: OSCAL v1.2
...
- **Backtick-wrapped paths** `` `dev/CODE-BACKLOG.md` `` — limited to
  <!-- PHANTOM 2026-05-18: declared SHIPPED but memo absent from disk. Regenerate from BACKLOG/test-fixture breadcrumbs before next release. -->
...
- **Django bridge** — full implicit-relationship resolution: admin → model (via `@admin.register` / `admin.site.register`), serializer/form/filterset → model (via `Meta.model`), `@receiver(sender=Model)`, `path()`/`re_path()`/`include()` URL trees, DRF `router.register()`, `@app.task`/`@shared_task` tagging. Companion `index/django_post.py` resolves transitive Django model inheritance + custom field metadata after the per-file extraction phase. New schema columns: `symbols.framework_type`, `field_type`, `field_metadata`; `edges.call_function`. Ported from `@LukasBerka/roam-code` — credit Lukas Berka.
- **`roam.git_utils.worktree_git_env(cwd)`** — sets `GIT_INDEX_FILE` per worktree so parallel agents in sibling worktrees don't contend on `.git/index.lock`. Wired into `discovery.py`, `git_stats.py`, `changed_files.py`, `cmd_index_bundle.py`. Ported from `@river-mounts/roam-code-sf` — credit Sam Hannan.
