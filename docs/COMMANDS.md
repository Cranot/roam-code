...
**287 commands** (280 canonical + aliases) across 7 categories · 246 MCP tools · roam v14.0.2
...
| `api` | stable | ✓ | — |
| `api-changes` | stable | ✓ | — |
| `article-12-check` | stable | ✓ | — |
| `attest` | stable | ✓ | — |
| `audit-trail-conformance-check` | stable | ✓ | — |
| `audit-trail-export` | stable | ✓ | — |
| `audit-trail-verify` | stable | ✓ | — |
| `bench-compile` | stable | — | — |
| `brief` | stable | ✓ | — |
| `capabilities` | stable | — | — |
| `compare` | stable | ✓ | — |
| `compile` | stable | ✓ | — |
| `compile-cache` | stable | — | — |
| `compile-daemon` | stable | — | — |
| `compile-stats` | stable | — | — |
| `constitution` | stable | — | — |
| `context` | stable | ✓ | — |
| `critique` | stable | ✓ | — |
| `diagnose` | stable | ✓ | — |
...
| `owner` | stable | ✓ | — |
| `path-coverage` | stable | ✓ | — |
| `report` | stable | ✓ | — |
| `risk` | stable | ✓ | — |
| `rules` | stable | ✓ | — |
| `sbom` | stable | ✓ | — |
| `secrets` | stable | ✓ | — |
| `simulate-departure` | stable | ✓ | — |
| `suggest-reviewers` | stable | ✓ | — |
| `supply-chain` | stable | ✓ | — |
| `taint` | stable | ✓ | — |
| `vuln-map` | stable | ✓ | — |
| `vuln-reach` | stable | ✓ | — |
...
| `lsp` | stable | — | — |
| `mutate` | experimental | ✓ | — |
| `orphan-imports` | stable | ✓ | — |
| `plan-refactor` | stable | ✓ | — |
| `safe-delete` | stable | ✓ | — |
| `sketch` | stable | ✓ | — |
| `split` | stable | ✓ | — |
| `stale-refs` | stable | ✓ | — |
| `suggest-refactoring` | stable | ✓ | — |
| `test-map` | stable | ✓ | — |
| `test-pyramid` | stable | ✓ | — |
